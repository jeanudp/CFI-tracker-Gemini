              ...
              <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="space-y-6">
                {(() => {
                  ...
                  if (rating.code === 'ppl') {
                    ...
                    ENDORSEMENTS = [
                      { key: 'A.1', text: 'I certify that [First name, MI, Last name] has met the eligibility requirements of §61.83 and has demonstrated satisfactory proficiency and safety as required by §61.87 in a [make and model aircraft].' },
                      { key: 'A.2', text: 'I certify that [First name, MI, Last name] has demonstrated satisfactory aeronautical knowledge of the rules and procedures that apply to student solo flight operations under §61.87(b)(1) through (14).' },
                      { key: 'A.3', text: 'I certify that [First name, MI, Last name] has received and logged flight training in the maneuvers and procedures listed in §61.87(d)(1) through (d)(n) and is prepared for the solo flight(s).' },
                      { key: 'A.4', text: 'I certify that [First name, MI, Last name] has received the required training of §61.87. I have determined that he/she is prepared to make solo flights in a [make and model aircraft]. This endorsement expires 90 days from the date signed.' },
                      { key: 'A.5', text: 'I certify that [First name, MI, Last name] has received solo cross-country training. I have reviewed the cross-country planning of the flight described below and find the planning and the student\'s preparation to be adequate for the proposed cross-country flight under VFR.' },
                      { key: 'A.6', text: 'I certify that [First name, MI, Last name] has received the required solo cross-country training and endorsements required by §61.93. I have determined that he/she is prepared to make the solo cross-country flight from [location] to [location] via [route of flight] in a [make and model aircraft].' },
                      { key: 'A.7', text: 'I certify that [First name, MI, Last name] has received the required training in [name of Class B airspace area]. I have determined he/she is prepared to conduct solo flight operations in that airspace.' },
                      { key: 'A.8', text: 'I certify that [First name, MI, Last name] has received the required training for [name of airport]. I have determined he/she is prepared to conduct solo flight operations at that airport.' },
                      { key: 'A.32', text: 'I certify that [First name, MI, Last name] has received the required training of §61.105. I have determined that he/she is prepared for the Private Pilot knowledge test.' },
                      { key: 'A.33', text: 'I certify that [First name, MI, Last name] has received the required training of §61.107(b)(1) through (b)(n). I have determined that he/she meets the applicable aeronautical experience requirements of §61.109 and is prepared for the Private Pilot practical test.' },
                      { key: 'A.34', text: 'I certify that [First name, MI, Last name] has received flight training within the preceding 60 days and I have determined he/she is prepared for the Private Pilot practical test.' }
                    ];
                    SOLO_OPTIONS = [
                      ...
                      { id: '2', label: 'Section 2 — Solo Cross-Country', description: 'Required for solo cross-country flights.', endorsements: ENDORSEMENTS.slice(4, 6) },
                      { id: '3', label: 'Section 3 — Solo Flight in Class B Airspace or to Class B Airport', description: 'Required for solo operations in or around Class B airspace.', endorsements: ENDORSEMENTS.slice(6, 8) },
                      { id: '4', label: 'Section 4 — Knowledge Test', description: 'Required before taking the Private Pilot knowledge test.', endorsements: ENDORSEMENTS.slice(8, 9) },
                      { id: '5', label: 'Section 5 — Practical Test Checkride', description: 'Required before taking the Private Pilot practical test.', endorsements: ENDORSEMENTS.slice(9, 11) }
                    ];
