            ...
            <>
              <div className="flex-1 overflow-y-auto overscroll-contain p-4 space-y-2">
                {(() => {
                  ...
                  const otherEndorsements = PPL_ENDORSEMENTS.filter(e => !CHECKRIDE_KEYS.includes(e.key));

                  const renderEndorsementButton = (e: typeof PPL_ENDORSEMENTS[0]) => {
                  ...
                  return (
                    <>
                      {otherEndorsements.map(renderEndorsementButton)}
                      <div className="pt-2">
                        ...
                        <div className="space-y-2">
                          {checkrideEndorsements.map(renderEndorsementButton)}
                        </div>
                      </div>
                    </>
                  );
