...
const ALL_ENDORSEMENTS: Record<string, EndorsementDef[]> = {
  ppl: [
    ...
    { key: 'A.72', title: 'To act as PIC in a complex airplane', ref: '14 CFR § 61.31(e)', template: 'I certify that {First name, MI, Last name}, {grade of pilot certificate}, {certificate number}, has received the required training of 14 CFR § 61.31(e) in a {make and model} complex airplane. I have determined that they are proficient in the operation and systems of a complex airplane.', group: 'Pilot Privileges' },
    { key: 'A.73', title: 'To act as PIC in a high-performance airplane', ref: '14 CFR § 61.31(f)', template: 'I certify that {First name, MI, Last name}, {grade of pilot certificate}, {certificate number}, has received the required training of 14 CFR § 61.31(f) in a {make and model} high-performance airplane. I have determined that they are proficient in the operation and systems of a high-performance airplane.', group: 'Pilot Privileges' },
    { key: 'A.75', title: 'To act as PIC in a tailwheel airplane', ref: '14 CFR § 61.31(i)', template: 'I certify that {First name, MI, Last name}, {grade of pilot certificate}, {certificate number}, has received the required training of 14 CFR § 61.31(i) in a {make and model} tailwheel airplane. I have determined that they are proficient in the operation of a tailwheel airplane.', group: 'Pilot Privileges' },
  ],
  ir: [
